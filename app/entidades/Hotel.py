...
class Hotel:
    ...
    def reservar_quarto(self, nome_usuario: str, quarto: int, checkin: str, checkout: str):
        '''
        Método para reservar um quarto
        '''
        return self.__controle_quartos.reservar(self.__lock_quartos, self.lock_clientes, nome_usuario, quarto, checkin, checkout)
